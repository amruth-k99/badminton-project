      ...
      <div className="bg-gray-50 py-2.5 fixed top-0 w-full">
        ...
        >
            ...
            <div className="flex items-center justify-between w-full md:w-auto">
              <Link href="/" className="py-2">
                <div className="flex items-center">
                  <span className="sr-only text-gray-900">
                    {CONFIG.APP_NAME}
                  </span>
                  <Image
              ...
              <div className="-mr-2 flex items-center md:hidden">
                <button
                  type="button"
                  onClick={handleClick}
                  className="bg-gray-900 rounded-md p-2 inline-flex items-center justify-center text-gray-900 hover:bg-white hover:text-white focus:outline-none focus:ring-2 focus-ring-inset focus:ring-white"
                  aria-expanded="false"
                >
          ...
          <div className="hidden md:flex md:items-center md:space-x-6">
            <Link
              href="#"
              className="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-white bg-gray-900 hover:bg-black"
            >
              Join Us
            </Link>
          </div>
